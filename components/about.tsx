...
export function About() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">EN VALKAI ODA OLI NEE</p>
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">THANKYOU FOR MAKING ME SMILE WHEN I DONT FEEL LIKE
        </h2>
      </motion.div>
